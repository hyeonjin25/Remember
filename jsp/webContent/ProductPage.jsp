		...
		<div id="inbox" style="width:80%; margin-top:30px;">
			<table >
				<%
					...
					ArrayList<ProductsBean>list = prodDAO.getList(pageNum);
				...
				%>
					<tr style="height:200px;">
						<td>
							<div class="product">
								<img alt="상품이미지" src="<%= list.get(i).getProdThumbnail() %>">
								<br>
								<div class="prodname">
									<a href="BbsViewPage.jsp?bbsID=<%= list.get(i).getProdID() %>"><%= list.get(i).getProdName() %></a>
								</div>
						...
						<td>
							<div class="product">
								<img alt="상품이미지" src="<%= list.get(i+1).getProdThumbnail() %>">
								<br>
								<div class="prodname">
									<a href="BbsViewPage.jsp?bbsID=<%= list.get(i+1).getProdID() %>"><%= list.get(i+1).getProdName() %></a>
								</div>
						...
						<td>
							<div class="product">
								<img alt="상품이미지" src="<%= list.get(i+2).getProdThumbnail() %>">
								<br>
								<div class="prodname">
									<a href="BbsViewPage.jsp?bbsID=<%= list.get(i+2).getProdID() %>"><%= list.get(i+2).getProdName() %></a>
								</div>
